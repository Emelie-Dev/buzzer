    ...
    const clickHandler = (e: Event) => {
      if (e.target) {
        if (
          ...
          const animation = searchSectionRef.current.animate(
            {
              width: ['35vw', '0'],
              opacity: [1, 0],
            },
            ...
            {searchText.trim().length > 0 ? (
              <div className={styles['search-results-div']}>
                <div className={styles['search-results-container']}>
                  ...
                  >
                    <IoSearchSharp className={styles['search-results-icon']} />
                ...
                <div className={styles['search-accounts-container']}>
                  <span className={styles['search-accounts-head']}>Users</span>
              ...
              <>
                ...
                <div className={styles['trending-search-container']}>
                  <span className={styles['recent-search-text']}>Trending</span>
                  ...
                  <div className={styles['recent-search-div']}>
                    ...
                    >
                      <HiTrendingUp className={styles['recent-search-icon']} />
                      <span className={styles['recent-search']}>davido</span>
                    </div>
